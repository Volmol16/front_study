  ...
  state: () => ({
    listOrderCards: [
      {
        ...
        rating: "8.5",
        description:
          "If you find this creation appealing, why not extend your appreciation to the talented minds Ive mentioned? ",
        price: 5000,
      },
      {
        id: 2,
    ...
    listUsers: [
        ...
        results: [
          {
            ...
            user: {
              username:
                "Q3UzxcPwAuBR1MghY-t-kZn1TiJ_+dbU_CCs0xkbS_@qqzGYIahtx_6bMiC+0U95uVvJamzkiil2hCc0EJUKxbIfS7eKO8I",
              first_name: "string",
              last_name: "string",
            ...
            comments: [
              {
                comment: "string",
                created_at: "2025-02-20T14:17:49.710Z",
                author: "string",
              },
            ],
          },
      ...
      },
      {
        ...
        description:
          "Я являюсь дипломированным химиком с 5-летним опытом работы в различных научно-исследовательских лабораториях. Обладаю глубокими знаниями в области химических наук и постоянно совершенствую свои навыки. Ответственно подхожу к выполнению любых заказов, гарантируя высокое качество  и точность результатов. Всегда открыт к сотрудничеству и готов оказать помощь в решении сложных химических задач.",
      },
      {
        id: 2,
        name: "Виктор Захаров",
